...
class RRotationArbitraryClockwiseTriangle extends Frame {
    ...
    public RRotationArbitraryClockwiseTriangle() {
        ...
        this.setTitle("Triangle Rotation about Arbitrary Point (Clockwise)");
        this.setLayout(null);
    ...
    public static void main(String[] args) {
        new RRotationArbitraryClockwiseTriangle();
    }
}