...
class RRotationOriginAntiClockwiseTriangle extends Frame {
    ...
    public RRotationOriginAntiClockwiseTriangle() {
        ...
        rabinpy1 = (int)(rabinx1 * Math.sin(rabinangle) + rabiny1 * Math.cos(rabinangle));
        rabinpx2 = (int)(rabinx2 * Math.cos(rabinangle) - rabiny2 * Math.sin(rabinangle));
        rabinpy2 = (int)(rabinx2 * Math.sin(rabinangle) + rabiny2 * Math.cos(rabinangle));
        rabinpx3 = (int)(rabinx3 * Math.cos(rabinangle) - rabiny3 * Math.sin(rabinangle));
        rabinpy3 = (int)(rabinx3 * Math.sin(rabinangle) + rabiny3 * Math.cos(rabinangle));

        this.setTitle("Triangle Rotation about Origin (Anti-Clockwise)");
        this.setLayout(null);
    ...
    public static void main(String[] args) {
        new RRotationOriginAntiClockwiseTriangle();
    }
}