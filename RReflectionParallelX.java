...
class RReflectionParallelXTriangle extends Frame {
    ...
    public RReflectionParallelXTriangle() {
        ...
        rabiny3 = sc.nextInt();
        System.out.println("Enter y-coordinate (b) of reflection axis y = b (relative to center)");
        rabinb = sc.nextInt();
        sc.close();

        rabinrx1 = rabinx1;
        rabinry1 = 2 * rabinb - rabiny1;
        rabinrx2 = rabinx2;
        rabinry2 = 2 * rabinb - rabiny2;
        rabinrx3 = rabinx3;
        rabinry3 = 2 * rabinb - rabiny3;
    ...
    public void paint(Graphics g) {
        ...
        int axisAwtY = centerY - rabinb;
        g.drawLine(0, axisAwtY, getWidth(), axisAwtY);
        g.drawString("Axis y = " + rabinb, 10, axisAwtY - 10);
    }

    public static void main(String[] args) {
        new RReflectionParallelXTriangle();
    }
}